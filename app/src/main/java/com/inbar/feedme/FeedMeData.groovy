...
class FeedMeData {
    static def israeliSalad = [
            id              : '1000',
            name            : 'Israeli Salad',
            prepTime        : 5,
            thumbnail       : R.drawable.rec_israeli_salad,
            favorite        : true,
            ingredients     : [[name    : 'Tomato',
                                   ...
                                   [name    : 'Extra virgin olive oil',
                                    amount  : 2,
                                    units   : 1],
                                   [name    : 'Table salt or atlantic sea salt',
                                    amount  : 2,
                                    units   : 18]],
            instructions    : ['Finely chop the tomato, cucmber and onion',
    ...
    static def scrambledEggs = [
            id              : '1001',
            name            : 'Scrambled Eggs',
            prepTime        : 5,
            thumbnail       : R.drawable.rec_scrambled_eggs,
            favorite        : true,
            ingredients     : [[name    : 'Eggs',
                               ...
                               [name    : 'Canola oil',
                                amount  : 1,
                                units   : 1]],
            instructions    : ['Break the eggs into a mixing bowl',
    ...
    static def kushkushPasta = [
            id              : '1002',
            name            : 'Kushkush Pasta',
            prepTime        : 15,
            thumbnail       : R.drawable.rec_pasta_egg,
            favorite        : true,
            ingredients     : [[name    : 'eggs',
                                amount  : 3,
                                units   : 21],
                               ...
                               [name    : 'grated Feta cheese',
                                amount  : 25,
                                units   : 11],
                               [name    : 'grated medium-hard cheese',
                                amount  : 25,
                                units   : 11],
                               [name    : 'table salt',
                                amount  : 2,
            ...
            instructions    : ['Boil the water in a pot ',
                               'Add the noodles and a pinch of salt',
                               'Let it cook for 5 minutes until the noodles are ready',
                               'Take the noodles off the stove and dr them in a strainer',
    ...
    static def kichriRice = [
            id              : '1003',
            name            : 'Kichri Rice',
            prepTime        : 30,
            thumbnail       : R.drawable.rec_kichri_rice,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def kubbehHamusta = [
            id              : '1004',
            name            : 'Kubbeh Hamusta',
            prepTime        : 60,
            thumbnail       : R.drawable.rec_kubbeh_hamusta,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def redKubbeh = [
            id              : '1005',
            name            : 'Red Kubbeh',
            prepTime        : 60,
            thumbnail       : R.drawable.rec_red_kubbeh,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def beetKubbeh = [
            id              : '1006',
            name            : 'Beet Kubbeh',
            prepTime        : 60,
            thumbnail       : R.drawable.rec_beet_kubbeh,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def onionSoup = [
            id              : '1007',
            name            : 'Onion Soup',
            prepTime        : 180,
            thumbnail       : R.drawable.rec_onion_soup,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def mashedFruits = [
            id              : '1008',
            name            : 'Mashed Fruits',
            prepTime        : 15,
            thumbnail       : R.drawable.rec_mashed_fruits,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def cheeseToast = [
            id              : '1009',
            name            : 'Cheese Toast',
            prepTime        : 17,
            thumbnail       : R.drawable.rec_cheese_toast,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static def shakshuka = [
            id              : '1010',
            name            : 'Shakshuka',
            prepTime        : 45,
            thumbnail       : R.drawable.rec_shakshuka,
            favorite        : false,
            ingredients     : [],
            instructions    : [],
            story           : null
    ...
    static DataFetcher recipeDataFetcher = new DataFetcher() {
        @Override
        Object get(DataFetchingEnvironment environment) {
            def id = environment.arguments.id
            recipeData[id]
